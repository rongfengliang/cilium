...
// RemoteEndpointMap is a mapping of IPs to their corresponding security identities,
// including endpoints on the host / on other nodes.
...
var (
	// RemoteEpMap is a mapping of all endpoint IPs in the cluster which this
